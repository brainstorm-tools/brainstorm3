function bst_deploy_java_2017b(IS_BIN)
...
%     end
    ...
    % Compiled jar
    compiledJar = fullfile(compilerOutputDir, 'bst_javabuilder_2017b.jar');
    ...
    classFile = fullfile('org', 'brainstorm', 'file', 'SelectMcr2017b.class');
    ...
    if file_exist(classFile)
        ...
        disp(['WARNING: Packaging without the installation runner, you must:' 10 ... 
              ' - Create and compile the Java project brainstorm_run_2017b' 10 ...
              ' - Copy RunCompiled.class to the packaging folder: ' 10 ...
              '   brainstorm3_deploy\R2017b\brainstorm_run\org\brainstorm']);
    end
    ...
    system(['cd "' jarDir '" & "' jdkDir '\bin\jar.exe" cmf manifest.txt "' bstJar '" bst_javabuilder_2017b org com']);
end
