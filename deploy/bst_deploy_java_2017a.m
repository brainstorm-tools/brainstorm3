function bst_deploy_java_2017a(IS_BIN)
% BST_DEPLOY_JAVA - Brainstorm deployment script.
%
% USAGE:  bst_deploy_java_2017a(IS_BIN=0)
%
% INPUTS:
...
if IS_BIN
    ...
    % FieldTrip / SPM
    if IS_FT_SPM
        compilerFile = fullfile(bstDir, 'deploy', 'bst_javabuilder_2017a_spm.prj');
    else
        compilerFile = fullfile(bstDir, 'deploy', 'bst_javabuilder_2017a.prj');
    end
...
%     end
    ...
    % Compiled jar
    compiledJar = fullfile(compilerOutputDir, 'bst_javabuilder_2017a.jar');
    ...
    classFile = fullfile('org', 'brainstorm', 'file', 'SelectMcr2017a.class');
    ...
    system(['cd "' jarDir '" & "' jdkDir '\bin\jar.exe" cmf manifest.txt "' bstJar '" bst_javabuilder_2017a org com']);
end
