...
paramFields.iso2mesh_laplacianhc = {'smoothing',   'Smoothing parameter: (0-1 less-more smoothing)',    '0.5'; ...
...
if isempty(Method)
    ...
    methods_str = ...
        ...
        '&nbsp;&nbsp;&nbsp;| - Calls the <CODE>sms.m</CODE> function with method = ''laplacian''.'], ...
        ...
        ...
        '&nbsp;&nbsp;&nbsp;| - Calls the <CODE>sms.m</CODE> function with method = ''laplacianhc''.'], ...
        ...
        ...
        '&nbsp;&nbsp;&nbsp;| - Calls the <CODE>sms.m</CODE> function with method = ''lowpass''.'], ...
    };
    % Ask method
...
switch Method
    ...
    case {'iso2mesh_laplacianhc', 'iso2mesh_laplacian', 'iso2mesh_lowpass'}
        ...
        % Smoothing parameter: iso2mesh function 'sms()' expects its complement (1 - smoothing)
        alpha = 1 - Params.smoothing;
        iter  = Params.iter;
        ...
        newTessMat.Vertices = sms(TessMat.Vertices, TessMat.Faces, iter, alpha, iso2meshArgMethod{2});
end
