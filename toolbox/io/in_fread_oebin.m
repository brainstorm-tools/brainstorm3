function F = in_fread_oebin(sFile, sfid, SamplesBounds, ChannelsRange)
% IN_FREAD_OEBIN:  Read a block of recordings from a Deltamed Coherence-Neurofile exported binary file
%
% USAGE:  F = in_fread_oebin(sFile, sfid, SamplesBounds=[], ChannelsRange=[])
