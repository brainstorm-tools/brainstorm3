...
%% ===== DISPLAY TIME RESOLUTION =====
    function DisplayTimeResolution(varargin)
        ...
        % Transient for 99% of the impulse response energy of the wavelet filter (real part of the complex Morlet wavelet)
        transient = 2.32 * (sOptions.MorletFwhmTc / 3) ./ sOptions.MorletFc;
        ...
        set(hAxes1, 'Position', [.08, .64, .34, .28]);
        % Time resolution
        ...
        line(transient.*[-1 -1], YLimWav, -0.1.*[1 1], ...
            ...
            'Color',     [.7 .7 .7], ...
            'Parent',    hAxes3);
        text(transient .* 1.1, YLimWav(2), '99% energy', ...
            'Color',               [.7 .7 .7], ...
            'FontSize',            bst_get('FigFont'), ...
            'FontUnits',           'points', ...
