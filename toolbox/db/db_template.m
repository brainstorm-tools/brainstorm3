...
switch lower(structureName)
    ...
    case 'subject'
        template = struct(...
          ...
          'iFEM',                {'int', []}, ...
          'iOther',              {'int', []}, ...
          'UseDefaultAnat',      {'bool', 0} , ... 
          'UseDefaultChannel',   {'bool', 1}, ...
          'Anatomy',             {'skip', repmat(db_template('Anatomy'),0)}, ...
          'Surface',             {'skip', repmat(db_template('Surface'),0)});
