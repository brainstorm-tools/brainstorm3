...
function html = PrintToHtml(Reports, isFullReport)
    ...
    html = ['<HTML>' 10 ...
            ...
            'h2 {font-size: ' num2str(13 * f) 'px; font-weight: bold; padding-top: 12px; padding-bottom: 12px;}' 10 ...
            'td {padding: 2px 2px 2px 2px; }' 10 ...
            '.bord td { border-width: 1px; border-style: solid; border-color: #bbbbbb; background-color: #f2f2f2; font: normal ' num2str(11 * f) 'px Verdana, Arial, Helvetica, sans-serif; }' 10 ...
            '.link {text-decoration: none; color: #0000a0;}' 10 ...
            '</STYLE>' 10 10 ...
            '<BODY style="margin: 5px 10px 10px 10px; font: normal ' num2str(11 * f) 'px Verdana, Arial, Helvetica, sans-serif; background-color: #e8e8e8;">' 10 ...
