...
function ComputeInteractive(iSubject, iMris, BemFiles) %#ok<DEFNU>
    ...
    switch (OPTIONS.Method)
        ...
        case 'zeffiro'
            ...
            advancedZefMsg = 'Would you like to use the advanced version of Zeffiro for mesh generation?';
            [res, isCancel] = java_dialog('question', [advancedZefMsg 10 ' This will open the advanced Zeffiro panel '], 'Zeffiro FEM Mesh Interface',...
                [], {'Brainstorm Basic Options', 'Zeffiro Advanced Options', 'Cancel'}, 'Brainstorm Basic Options');
           
            if isCancel || strcmpi(res, 'Cancel')
                return
            end
