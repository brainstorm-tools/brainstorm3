...
% PROCESS_HENV1: Compute the time-varying Coherence and envelope measures using Hilbert transform and Morlet Wavelet
...
function sProcess = GetDescription() 
    ...
    sProcess.Comment     = 'Envelope Correlation 1xN [2023]';
...
%     sProcess.options.tfsplit.Class   = 'hilbert';
    % === TIME AVERAGING
    % Full would require modifying how correlation is computed
