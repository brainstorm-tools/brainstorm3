function varargout = process_henv(varargin)
% PROCESS_HCOH: Compute the time-varying COherence and enVELope measures using Hilbert transform 
% and Morlet Wavelet between all pairs of channels, in one file.

% USAGE:  OutputFiles = process_henv('Run', sProcess, sInputA)
% @=============================================================================
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.options.cohmeasure.Comment = {'Coherence', 'Lagged Coherence', ...
        'Env. Cor. (w/o Orth.)','Env. Cor. (w/ Orth.)','Measure: '};
...
function OutputFiles = Run(sProcess, sInputA) %#ok<DEFNU>
    ...
    switch (sProcess.options.cohmeasure.Value)
        ...
        case 3,  OPTIONS.CohMeasure = 'penv';
        case 4,  OPTIONS.CohMeasure = 'oenv';
    end
