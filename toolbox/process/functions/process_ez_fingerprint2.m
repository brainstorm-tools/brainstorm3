function varargout = process_ez_fingerprint2( varargin )
% process_ez_fingerprint2: open EZ Fingerprint or prompt to download
...
function OutputFiles = Run(sProcess, sInputsA, sInputsB) %#ok<DEFNU>
    OutputFiles = process_ez_fingerprint1('Run');    
end
