...
function OPTIONS = GetConnectOptions(sProcess, sInputA) %#ok<DEFNU>
    ...
    isConnNN = ismember(OPTIONS.ProcessName, {'process_corr1n', 'process_cohere1n', 'process_granger1n', 'process_spgranger1n', 'process_plv1n', 'process_corr1n_time', 'process_cohere1n_time', 'process_phasete1n'});
