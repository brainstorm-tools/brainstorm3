...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.options.help.Comment  = ['This process replaces a short time window around an event<BR>' ...
                                      'with a linear interpolation between the previous and the<BR>' ...
                                      'following time sample. Consider this option only for removing<BR>' ...
                                      'segments of a few data samples.<BR><BR>'];
