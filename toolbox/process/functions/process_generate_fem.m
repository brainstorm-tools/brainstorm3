...
switch lower(OPTIONS.Method)
    ...
    case 'simnibs'
        ...
        commandLine = ['headreco all --noclean  '  ...
            bst_fullfile(data.SUBJECTS, MriFile) ' ' ...
            outputMeshFilename ' ' pathToT1 ' ' pathToT2];
        system(commandLine)
        ...
        % Call Jaun process
        sMri=load(bst_fullfile(data.SUBJECTS, MriFile));
