    ...
    for k = 1:length(sScouts)
        ...
        if (nComponents == 1)
            ...
            isNIRS = ~isempty(strfind(TestTags, 'NIRS')) || ...
                     ...
                     ( isfield( GlobalData.DataSet(iDS).Results(iResult), 'DisplayUnits') && ~isempty( strfind(GlobalData.DataSet(iDS).Results(iResult).DisplayUnits, 'mol.l-1'))) || ...
            ...
            GlobalData.DataSet(iDS).Results(iResult).DisplayUnits
