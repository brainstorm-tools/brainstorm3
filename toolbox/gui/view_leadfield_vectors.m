        ...
        switch (keyEvent.Key)
            ...
            case 'h'               
                message = sprintf([...
                    ...
                    'Shift + ↑ : Increase the vector length\n', ...
                    'Shift + ↓ : Decrease the vector length\n', ...
                    'Shift + L : Toggle on/off logarithmic scale\n', ...
                    'Ctrl + ↑ : Increase the vector width\n', ...
                    'Ctrl + ↓ : Decrease the vector width\n', ...
                    'Alt + Enter : Toggle to superior/inferior for LF threshold\n', ...
                    'Alt + ↑ : Increase Amplitude threshold\n', ...
                    'Alt + ↓ : Decrease Amplitude threshold\n', ...
                    ...
                    'Shift + E : Show/hide the sensor labels\n', ...
                    '0 to 9 : Change view']);

                helpdlg(message, 'Keyboard Shortcuts');
            otherwise
