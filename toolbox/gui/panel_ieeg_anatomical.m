...
function Help(varargin) %#ok<DEFNU>
    java_dialog('msgbox', ...
                ['<HTML>' ...
                 '1. Press <B>''L''</B> for starting new electrode labeling<BR>' ...
                 '2. Press <B>''R''</B> for resuming electrode labeling<BR>' ...
                 '3. The <B>''DrawRef''</B> button is used to plot reference electrode which can be used as a guideline<BR>' ...
                 '4. The <B>''DispRef''</B> button toggles between showing/hiding the reference electrodes<BR>' ...
                 '5. The <B>''DelLast''</B> button deletes the last plotted contact in the list<BR>' ...
                 '6. The <B>''DelAll''</B> button deletes everything in the list of contacts<BR>' ...
                 '7. The <B>''Save''</B> button saves the session<BR>' ...
                 '<BR><B>NOTE: Make sure to read the instructions and messages that pop up<BR>' ...
                 '</HTML>'], ...
                'How to use the tool');
end
