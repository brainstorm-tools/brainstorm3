        ...
        switch (keyEvent.Key)
            ...
            case 'h'
                ...
                java_dialog('msgbox', ['<HTML><B> Lead Field Arrow : keyboard shortcut help </B> <BR>' ...
                    ...
                    '<B>pageup :</B> highlight previous 10th channel<BR>'....
                    '<B>R :</B> change the reference electrode<BR>'....
                    '<B>V :</B> display or hide the cortex vertices<BR>'....
                    '<B>C :</B> display or hide the channles<BR>'....
                    '<B>M :</B> change/select modality (MEG, EEG, SEEG, ECOG)<BR>'....
                    '<B>H :</B> display this help :)<BR>']);
            otherwise
