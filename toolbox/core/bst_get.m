        ...
        switch lower(varargin{2})
            ...
            case 'channelout'
                argout1 = {...
                    ...
                    {'_optrodes.tsv'}, 'NIRS: BIDS optrodes.tsv, subject space mm (*.tsv)',     'BIDS-NIRS-SCANRAS-MM'; ...
                    {'_optrodes.tsv'}, 'NIRS: BIDS optrodes.tsv, MNI space mm (*.tsv)',         'BIDS-NIRS-MNI-MM'; ...
                    {'_optrodes.tsv'}, 'NIRS: BIDS optrodes.tsv, ALS/SCS/CTF space mm (*.tsv)', 'BIDS-NIRS-ALS-MM'; ...
                    {'_channels.tsv'}, 'NIRS: BIDS channels.tsv, (*_channels.tsv)', 'BIDS-NIRS-channel'; ...
                    };
            case 'labelin'
                argout1 = {...
