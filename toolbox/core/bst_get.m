...
%% ==== ANATOMY DEFAULTS ====
    ...
    case 'AnatomyDefaults'
        ...
        if ~ismember(lower({sTemplates.Name}), 'icbm152')
            sTemplates(end+1).FilePath = 'http://neuroimage.usc.edu/bst/getupdate.php?t=ICBM152_2016b';
...
%         end
        if ~ismember(lower({sTemplates.Name}), 'icbm152_2016b')
            sTemplates(end+1).FilePath = 'http://neuroimage.usc.edu/bst/getupdate.php?t=ICBM152_2016b';
            sTemplates(end).Name = 'ICBM152_2016b';
        end
