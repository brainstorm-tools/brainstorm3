function tutorial_visual_copy_orig(ProtocolNameSingle, ProtocolNameGroup, reports_dir)
% TUTORIAL_VISUAL_COPY_ORIG: Copy the subject averages for the Brainstorm/SPM group tutorial into a new protocol.
%
% ONLINE TUTORIALS: 
