...
% Process: Select results files in: sub-01/sub-01_ses-meg_task-facerecognition_run-01_proc-tsss_meg
sFiles = bst_process('CallProcess', 'process_select_files_results', [], [], ...
    'subjectname', 'sub-01', ...
    'condition',   'sub-01_ses-meg_task-facerecognition_run-01_proc-tsss_meg');
if isempty(sFiles)
    error(['No source files available in folder: sub-01/sub-01_ses-meg_task-facerecognition_run-01_proc-tsss_meg.' 10 ...
