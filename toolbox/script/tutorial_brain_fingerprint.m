...
% Cortical parcellation (atlas)
    % Note we downsample the cortical surface using an atlas for computation
    % efficency 
AtlasName = 'Destrieux';
...
df_b = nSubjects-1;             % degrees of freedon for s2
df_w = nSubjects*(nSegments-1); % degrees of freedon for r
