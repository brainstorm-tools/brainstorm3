...
nwb.general_subject = types.core.Subject( ...
    'subject_id', '005', ...
    'description', 'mouse 5', ...
    'age', 'P90D', ...  % ISO 8601 Duration format: "Period of 90 Days"
    'sex', 'M', ...  % prefer M, F, O, or U
    'species', 'Mus musculus');  % prefer latin binomial name
...
plane_segmentation = types.core.PlaneSegmentation( ...
    ...
    'id', types.hdmf_common.ElementIdentifiers('data', 0:19), ...
    'imaging_plane', types.untyped.SoftLink(imaging_plane_path));
